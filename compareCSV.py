...
def subtract_csv_files(file1, file2, output_file):
    ...
    # Assuming that the timestamp is the last column (6th column)
    timestamp_column = df1.columns[-1]

    # Select the columns to be subtracted (columns 1 to 5 from the first DataFrame)
    columns_to_subtract = df1.columns[0:5]
